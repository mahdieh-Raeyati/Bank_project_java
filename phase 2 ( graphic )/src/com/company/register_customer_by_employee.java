...
public class register_customer_by_employee extends register_pannel {
    Employee employee;

    public register_customer_by_employee(Employee employee) {
        super();
    ...
    public void button1MouseClicked(MouseEvent e) {
        ...
        if (a) {
            ...
            setting_password_for_customer_by_employee setting_password_for_customer_by_employee
                    = new setting_password_for_customer_by_employee(FirstnField1.getText(), LastnameField.getText(),
                    NationalIDField3.getText(), phoneField5.getText(), gender, Email.getText(),
                    birthdate, address.getText(), employee);
            setting_password_for_customer_by_employee.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
            setting_password_for_customer_by_employee.setVisible(true);
            dispose();
        }
