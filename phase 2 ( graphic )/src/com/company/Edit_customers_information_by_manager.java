...
public class Edit_customers_information_by_manager extends register_pannel {
    Customer customer;
    Manager manager;

    public Edit_customers_information_by_manager(Customer customer, Manager manager) {
        super();
