/*
 * Created by JFormDesigner on Sat Jul 25 20:04:30 IRDT 2020
 */
 ...
 * @author mahdieh
 */
public class manage_customer_by_manager extends JFrame {
    private Manager manager;

    public manage_customer_by_manager(Manager manager) {
        initComponents();
    ...
    private void button1MouseClicked(MouseEvent e) {
        register_customer_by_manager register_customer_by_manager = new register_customer_by_manager(manager);
        register_customer_by_manager.setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        register_customer_by_manager.setVisible(true);
        dispose();
    }
    ...
    private void button2MouseClicked(MouseEvent e) {
        recive_information_by_manager recive_national_id_to_remove = new recive_information_by_manager(manager, 2);
    ...
    private void button3MouseClicked(MouseEvent e) {
        recive_information_by_manager recive_national_id_for_manager = new recive_information_by_manager(manager, 4);
                                    ...
                                    .addGroup(panel1Layout.createParallelGroup()
                                            .addGroup(panel1Layout.createSequentialGroup()
                                                    ...
                                                    .addGroup(panel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                                                            .addComponent(button1, GroupLayout.DEFAULT_SIZE, 176, Short.MAX_VALUE)
                                                            .addComponent(button2, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 176, Short.MAX_VALUE)
                                                            .addComponent(button3, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 176, Short.MAX_VALUE)
                                                            .addComponent(button4, GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 176, Short.MAX_VALUE)
